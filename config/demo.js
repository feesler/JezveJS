...
export default {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: './Views/Input/input.html',
            filename: 'demo/input.html',
            chunks: ['polyfills', 'inputDemo'],
            ...htmlCommonOptions,
        }),
        new HtmlWebpackPlugin({
        ...
        new HtmlWebpackPlugin({
            template: './Views/Tags/tags.html',
            filename: 'demo/tags.html',
            chunks: ['polyfills', 'tagsDemo'],
            ...htmlCommonOptions,
        }),
        new HtmlWebpackPlugin({
