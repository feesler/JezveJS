...
class PieChartView extends DemoView {
    ...
    onStart() {
        ...
        this.addContentsMenuItem({ title: 'Title and offset sector', url: 'offset' });
        this.addContentsMenuItem({ title: '\'innerRadius\' option', url: 'innerRadius' });
        this.addContentsMenuItem({ title: 'Single value', url: 'single' });
